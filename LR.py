...
plt.title( 'Hate/NonHate distribution for the test data set using the labels predicted by the classifier model Bag of Words LR ')
plt.figure(10)
plt.pie(arr5, labels = mylabels5 ,autopct='%1.1f%%')
plt.title( 'Hate/NonHate distribution for the test data set using the labels predicted by the classifier model TFIDF LR')
plt.figure(11)
plt.pie(arr6, labels = mylabels6,autopct='%1.1f%%')
plt.title('Hate/NonHate distribution for the test data set using the labels predicted by the classifier model  LR ')

#plot model confidence scores using LR
